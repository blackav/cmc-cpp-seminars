...
В качестве основного компилятора будет использоваться g++ версии 13.
Как альтернативный компилятор будет использоваться clang++ 16.
По умолчанию будет стоять флаг компиляции `-std=gnu++23`, то есть
поддержка самых последних фич стандарта, которые успели реализовать.

## Ресурсы для изучения и использования C++

Курс Владимирова (MIPT) на YouTube:
